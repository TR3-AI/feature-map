...
Once the 2x withdrawal confirms, 20% of the remaining position is flagged as the moon bag, manual-only, excluded from every automatic exit, ending only on Bobby's manual sell from the UI.
