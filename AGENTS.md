...
13. **P-stack below governs every map** — the full P-stack principles and skills, copied like-for-like from pstack v0.14.8 (`github.com/cursor/plugins/tree/main/pstack`). No snippets, no paraphrase. Do NOT run `/poteto-mode Feature` while writing the map: one feature file = behaviors + proof — execution comes later.
...
#### `pstack/skills/principle-prove-it-works/SKILL.md` — verbatim
...
#### `pstack/skills/principle-build-the-lever/SKILL.md` — verbatim
...
#### `pstack/skills/principle-make-operations-idempotent/SKILL.md` — verbatim
...
#### `pstack/skills/principle-boundary-discipline/SKILL.md` — verbatim
...
#### `pstack/skills/create-verification-skill/SKILL.md` — verbatim
...
#### `pstack/skills/maintain-verification-skill/SKILL.md` — verbatim
